...
public class SpellAuraRefresh extends SpellBaseEvent {
	private String auraType;

	public SpellAuraRefresh() {}
	...
	public boolean equals(Object other) {
		if (other == null || !(other instanceof SpellAuraRefresh) || !super.equals(other))
			return false;
		if (other == this)
			return true;

		SpellAuraRefresh that = (SpellAuraRefresh)other;
