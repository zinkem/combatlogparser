...
public class SpellAuraRemoved extends SpellBaseEvent {
	private String auraType;

	public SpellAuraRemoved() {}
	...
	public boolean equals(Object other) {
		if (other == null || !(other instanceof SpellAuraRemoved) || !super.equals(other))
			return false;
		if (other == this)
			return true;

		SpellAuraRemoved that = (SpellAuraRemoved)other;
