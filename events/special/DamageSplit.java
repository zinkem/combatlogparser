...
public class DamageSplit extends SpellBaseEvent implements DamageEventInterface {
	private int amount;
	...
	public boolean equals(Object other) {
		if (other == null || !(other instanceof DamageSplit) || !super.equals(other))
			return false;
		if (other == this)
			return true;

		DamageSplit that = (DamageSplit)other;
